  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4">
      <div className="flex items-center justify-end gap-2 mb-3">
        ...
        {isAuthor && (
          <button onClick={onDelete} className="text-muted-foreground hover:text-destructive transition-colors">
            <TossIcon name="icon-trash-mono" size={14} />
          </button>
        )}
      </div>
      ...
      {isAuthor && application.status === "pending" && (
        ...
        >
          <TossIcon name="icon-check-mono" size={16} />
          {"수락하기"}
        </Button>
      )}
      ...
      {isAccepted && (
        <div className="flex items-center gap-2 p-3 bg-primary/5 rounded-xl border border-primary/20 mt-2">
          <TossIcon name="icon-phone-mono" size={16} />
          <div>
        ...
        user ? (
          <div key={i} className="relative flex flex-col items-center gap-1 p-1.5 rounded-xl bg-primary/10 ring-1 ring-primary">
            {i > 0 && (
              ...
              >
                <TossIcon name="icon-close-mono" size={10} />
              </button>
            )}
  ...
  return (
    <div className="bg-card rounded-xl border border-border p-4">
      <h3 className="text-sm font-semibold mb-3 flex items-center gap-2">
        <TossIcon name="icon-users-mono" size={16} />
        ...
        {Array.from({ length: openSlots }).map((_, i) => (
          ...
          >
            <div className="w-12 h-12 rounded-full border-2 border-dashed border-muted-foreground/30 flex items-center justify-center">
              <TossIcon name="icon-plus-small-mono" size={20} className="opacity-40" />
            </div>
      ...
      <main className="flex-1 px-4 py-4 pb-6 flex flex-col gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          {isAuthor && (
            <div className="relative">
              ...
              >
                <TossIcon name="icon-more-vertical-mono" size={16} className="opacity-70" />
              </button>
              {showPostMenu && (
        ...
        <div className="bg-card rounded-xl border border-border p-4 flex flex-col gap-3">
          <div className="flex items-center gap-2 text-sm">
            <TossIcon name="icon-location-mono" size={16} className="shrink-0" />
            <span>{displayLocation}</span>
          </div>
          <div className="flex items-center gap-2 text-sm">
            <TossIcon name="icon-calendar-mono" size={16} className="shrink-0" />
        ...
        <div className="flex flex-col gap-3">
          <h3 className="text-sm font-semibold flex items-center gap-2">
            <TossIcon name="icon-message-mono" size={16} />
            {"미팅 신청"}
          ...
          {isAuthor ? (
            ...
            <>
              ...
              <div className="bg-card rounded-xl border border-border p-4 flex items-center gap-3">
                <TossIcon name="icon-lock-mono" size={20} className="opacity-70" />
                <div>
        ...
        {!isAuthor && !showApplyForm && openSlots > 0 && post.status === "open" && (
          ...
          >
            <TossIcon name="icon-send-mono" size={16} />
            {"미팅 신청하기"}
          </Button>
        )}
